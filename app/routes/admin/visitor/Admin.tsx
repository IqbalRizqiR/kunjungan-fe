    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            const res = await api.post('/visits/book', {
                ...
                email: email,
                sessionId: "cme4jlum0000anzhjhh49b93b",
                ...
                startTime: startTime,
                endTime: endTime,
                status: 'APPROVED', // Flag to indicate admin created this visit
            });
                            ...
                            <div key={visit.id} className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600">Email: {visit.user.email}</p>
                                        <p className="text-sm text-gray-600">Phone: {visit.user.phoneNumber}</p>
...
c                                        {(visit.sessionId || (startTime && endTime)) && (
                                        ...
                                        <p className="text-sm text-gray-600">Status: 
                                            <span className={`ml-1 px-2 py-1 rounded text-xs ${
                                                ...
                                                visit.status === 'REJECTED' ? 'bg-red-100 text-red-800' : 'bg-gray-100 text-gray-800'
                                            }`}>
